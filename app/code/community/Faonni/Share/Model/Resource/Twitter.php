 ...
 */
class Faonni_Share_Model_Resource_Twitter
	extends Faonni_Share_Model_Resource_Abstract
{
     ...
     * @var string
     */
	protected $_shareUrl = 'http://twitter.com/share';
     ...
     * @var string
     */
	protected $_countUrl = 'http://cdn.api.twitter.com/1/urls/count.json?url=';
	...
	public function getShareUrl()
	{
		$this->_shareQuery = array_merge(
			$this->_shareQuery, array(
				...
				'text' => $this->getShareObject()->getTitle()
			)
		);
